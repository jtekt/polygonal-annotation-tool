...
do
  ...
  sed -i 's|VUE_APP_DEFAULT_LABEL_PLACEHOLDER|'${VUE_APP_DEFAULT_LABEL}'|g' $file
  ...
  sed -i 's|VUE_APP_ENABLE_BRUSH_PLACEHOLDER|'${VUE_APP_ENABLE_BRUSH}'|g' $file
  sed -i 's|VUE_APP_ENABLE_POLYLINE_PLACEHOLDER|'${VUE_APP_ENABLE_POLYLINE}'|g' $file
