...
const {
    ...
    VUE_APP_WS_SERVER_URL,
    VUE_APP_LABELS,
    VUE_APP_ANNOTATION_FIELD,
} = process.env
...
export default {
    ...
    data() {
        return {
            ...
            api_url: VUE_APP_STORAGE_SERVICE_API_URL,
            ws_url: VUE_APP_WS_SERVER_URL,
            labels: VUE_APP_LABELS,
            ...
            services: [
                ...
                },
                {
                    ...
                    url: VUE_APP_STORAGE_SERVICE_API_URL,
                    version: null,
                },
            ],
        }
